var TabButtonsIds;
(function (TabButtonsIds) {
    TabButtonsIds["Player"] = "playerNav";
    TabButtonsIds["Channels"] = "channelsNav";
    TabButtonsIds["Bookmarks"] = "bookmarksNav";
})(TabButtonsIds || (TabButtonsIds = {}));
var ScreensIds;
(function (ScreensIds) {
    ScreensIds["Player"] = "player";
    ScreensIds["Channels"] = "channels";
    ScreensIds["Bookmarks"] = "bookmarks";
...
function initializePopupPage() {
    const APP_BACKGROUND_DATA = BACKGROUND.getAppBackgroundData();
